...
**Revision 15 — OntoQA structural profile reclassified from held out to loop-coupled. Full OOPS! report fed back with no pitfall suppression; pitfall-overlap audit removed. Same standing-priority logic as revision 11.1: withholding feedback to protect a secondary metric would produce worse ontologies. Held-out set simplified to CQ answerability, salient-term coverage, and genre coverage balance. No hypotheses, primary outcomes, or statistical plan changed. Prior revision history: v14 injection source and alignment-rate redesign; v13 E-code simplification; v12 reconciled against codebook v12; v11.4 D1 iteration on sub-ontologies with anchored re-integration; v11.3 three-allotment prompt decomposition; v11.2 corpus presentation order and deterministic windowing; v11.1 OOPS! retained in feedback loop with pitfall-overlap audit; v11 loop-coupled instruments identified and quarantined.**


*Body text presents the current design without backward references to prior revisions. Change logs are in the companion file **dissertation_change_logs_v15.md**.*
...
Moved to the companion file **dissertation_todo_v15.md**, which integrates the human-effort inventory and the sequenced next-actions list into a single task list with effort estimates and dependency tracking.
