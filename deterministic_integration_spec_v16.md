# Deterministic Integration and Defect Routing for D1 — Specification

Companion to dissertation_overview_and_paper_outlines_v15.md, Part I §5
(D1 integration), §4.4a (feedback routing), and Paper 1 §5.3
(integration descriptives).

Implements task 4b of dissertation_todo_v15.md.
...
integrated artefact, computed at every round on the grounding-agnostic
instruments. This is the headline measure of what decomposition costs.
...
## 9. What this changes in the pilot (task 6)

The pilot still runs (2 seeds × 2 conditions × R = 15), but its
purposes simplify:
